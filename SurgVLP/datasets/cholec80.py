...
negated_templates_4 = "I use {} but I don't use {}"
...
class Cholec80(MultiLabelDatasetBase):
    def __init__(self, config):
        ...
        self.negated_templates_2 = self.generate_negated_template_2()
    ...
    def generate_negated_template_2(self):
        # Generate 6 kinds of templates
        res_templates = []
        for i in range(1, 7):
            tmp_templates = []
            for class_i in range(7):
                tmp_templates.append(f"{short_templates[(class_i + i) % 7]} but {self.negated_templates[class_i]}")
                res_templates.append(tmp_templates)
